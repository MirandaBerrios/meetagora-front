...
class OptionsModel extends FlutterFlowModel<OptionsWidget> {
  ...
  // Stores action output result for [Backend Call - API (updateNicknameApi)] action in Button widget.
  ApiCallResponse? apiResult;
  bool isDataUploading = false;
  FFUploadedFile uploadedLocalFile =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  // Stores action output result for [Backend Call - API (profileImageApi)] action in Button widget.
