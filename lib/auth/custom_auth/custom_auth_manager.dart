...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    meetagoraAppAuthUserSubject.add(
      MeetagoraAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MeetagoraAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MeetagoraAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MeetagoraAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    meetagoraAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MeetagoraAppAuthUser? currentUser;
